defmodule Heroix.GameRunner do
  ...
  def handle_info(msg = {:DOWN, _os_pid, :process, pid, :normal}, state = %{app_name: app_name, legendary_pid: legendary_pid}) do
  ...
  def handle_info(msg = {:DOWN, os_pid, :process, _pid, {:exit_status, exit_status}}, state = %{game_pid: game_pid, app_name: app_name}) do
